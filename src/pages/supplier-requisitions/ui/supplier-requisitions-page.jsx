...
export function SupplierRequisitionsPage() {
    ...
    return (<div className="space-y-8">
            <AdminPageHeader title="Phiếu yêu cầu nhà cung cấp" description="Theo dõi yêu cầu bổ sung hàng, phê duyệt và xác nhận luân chuyển tồn kho."/>

            <div className="space-y-4">
                {requisitions.map((requisition) => (<SurfaceCard key={requisition.id} className="space-y-4">
