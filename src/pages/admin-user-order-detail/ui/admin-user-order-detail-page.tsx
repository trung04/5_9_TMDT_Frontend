...
export function AdminUserOrderDetailPage() {
        ...
        return (
            <div className="space-y-6">
                <AdminPageHeader
                    ...
                    description="Khong the mo trang chi tiet don hang nay."
                    actions={
                        <ButtonLink to={backToOrders} variant="secondary">
    ...
    if (customerError && !customer) {
        return (
            <div className="space-y-6">
                <AdminPageHeader
                    title="Chi tiet don hang"
                    description="Khong the tai thong tin customer de hien thi chi tiet don."
                    actions={
                        <ButtonLink to={backToOrders} variant="secondary">
                            Quay lai lich su don hang
                        </ButtonLink>
    ...
    if (orderError && !order) {
        return (
            <div className="space-y-6">
                <AdminPageHeader
                    title="Chi tiet don hang"
                    description="Khong the tai du lieu don hang."
                    actions={
                        <ButtonLink to={backToOrders} variant="secondary">
                            Quay lai lich su don hang
                        </ButtonLink>
    ...
    if (isCustomerMismatch) {
        return (
            <div className="space-y-6">
                <AdminPageHeader
                    title="Chi tiet don hang"
                    description="Don hang nay khong thuoc customer tren duong dan hien tai."
                    actions={
                        <ButtonLink to={backToOrders} variant="secondary">
                            Quay lai lich su don hang
                        </ButtonLink>
    ...
    return (
        <div className="space-y-8">
            <AdminPageHeader
                title={order?.order_no ?? "Chi tiet don hang"}
                description={
                    customer
