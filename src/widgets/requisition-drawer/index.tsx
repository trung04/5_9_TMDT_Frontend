...
import type { SupplierPartner } from "@/entities/user/model/types";
...
export function RequisitionDrawer({
    ...
    return (
        <div className="fixed inset-0 z-50 bg-on-surface/30 backdrop-blur-sm">
                    ...
                    <div className="space-y-6">
                        <SurfaceCard tone="low" className="space-y-4">
                            <div className="flex items-center justify-between">
                                ...
                                <Badge
                                    tone={
                                        inventoryItem.status === "critical" ? "danger" : "warning"
                                    }
                                >
                        ...
                        <SurfaceCard tone="lowest" className="space-y-4">
                            ...
                            <label className="space-y-2 text-sm">
                                ...
                                <textarea
                                    className={cn(
                                        "min-h-28 w-full rounded-2xl border border-transparent bg-surface-container-highest px-4 py-3 text-sm text-on-surface outline-none transition focus:border-primary/20 focus:ring-2 focus:ring-primary/15",
                                    )}
                                    value={draft.note}
                                    onChange={(event) =>
                                        setDraft((current) => ({
                        ...
                        {selectedSupplier ? (
                            <SurfaceCard tone="low" className="space-y-3">
                                <h4 className="text-xs font-label uppercase tracking-widest text-on-surface-variant">
